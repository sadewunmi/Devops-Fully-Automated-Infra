    ...
    stages {
     ...
     post { 
        always { 
            ...
            slackSend channel: '#stephens-cicd-alerts', color: COLOR_MAP[currentBuild.currentResult], message: "*${currentBuild.currentResult}:* Job ${env.JOB_NAME} build ${env.BUILD_NUMBER} \n More info at: ${env.BUILD_URL}"
        }
    }
